          ...
          <form method="POST">
            <div class="form-row">
              <div class="form-group col-md-3 required" >
                <label  class="control-label" for="inputEmail4">Počet kreditov k ukončeniu štúdia</label>
            ...
            <div class="form-row">
              <div class="form-group col-md-3 required">
                ...
                <input type="number" class="form-control" id="inputPassword4" placeholder="12" name="pocet" value="<?php if (isset($_POST['pocet'])) echo $_POST["pocet"];?>" required>
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-3 required">
                <label class="control-label" for="inputAddress">ročný kreditový strop štúdia</label>
